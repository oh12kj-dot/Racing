# TODO_ARCHIVE.md — 完了タスクの記録アーカイブ

TODO.md 本体の肥大化（トークン消費）を抑えるため、完了・監査済みで今後参照頻度が低いタスク記録をここへ退避した。
対象: TASK-2-4 Phase 1 land 完了報告 以降〜TASK-1B-2 まで（Phase 1B / TASK-2-1 / TASK-2-2 / TASK-2-3 / TASK-2-4 Phase 1）。
**現在進行中の TASK-2-4 Phase 2 の記録は TODO.md 本体に残っている。**
