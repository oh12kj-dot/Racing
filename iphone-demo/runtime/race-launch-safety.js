...
export function createRace(W,statusEl,settings={}){
  ...
  return new Proxy(R,{get(target,prop){if(prop==='update')return update;if(prop==='spinControl')return{suppressed:0,mode:'incident-probability-controlled-at-source'};if(prop==='startControl')return{gridNormalised,raceStartAt};return Reflect.get(target,prop,target);}});
}
