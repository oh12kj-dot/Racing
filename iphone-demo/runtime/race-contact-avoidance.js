...
export function createRace(W,statusEl,settings={}){
  ...
  let raceStartAt=null,interventions=0,lateralVetoes=0,multiclassPassesArmed=0;
  ...
  function predictiveAvoidance(dt){
    for(const c of R.cars){const launch=c.launchSpeedCap;c.predictiveSpeedCap=launch!=null&&Number.isFinite(Number(launch))&&Number(launch)>=0?Number(launch):null;c.multiclassPassIntent=false;c.multiclassPassTargetId=null;c.multiclassPassLane=null;}
