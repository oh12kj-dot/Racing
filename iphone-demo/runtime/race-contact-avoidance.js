...
export function createRace(W,statusEl,settings={}){
  ...
  let raceStartAt=null,interventions=0;
  ...
  return new Proxy(R,{get(target,prop){if(prop==='update')return update;if(prop==='collisionAvoidance')return{raceStartAt,interventions,mode:'predictive-only-physical-obb-authoritative'};return Reflect.get(target,prop,target);}});
}
