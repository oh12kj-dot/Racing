...
export function createUI(W,R,D,E,C,A,settings,saveSettings){
  const U=createBaseUI(W,R,D,E,C,A,settings,saveSettings),baseUpdate=U.update;let acc=0,lastFocus=0,updates=0,skipped=0,initialized=false;const hz=12,step=1/hz;
