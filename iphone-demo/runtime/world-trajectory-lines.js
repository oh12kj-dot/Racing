...
export function buildWorld(THREE,TRACK,settings={},circuitName='SUZUKA'){
  ...
  // Finite-horizon line optimizer. It preserves the geometric apex solution but
  // anticipates the next 80-140 m, so chicanes and linked corners are treated as
  // one trajectory instead of unrelated outside-apex-outside commands.
